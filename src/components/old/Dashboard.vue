                ...
                <b-card :title="book.title + ' (' + book.words.length + ')'">
                    ...
                    <b-form-group>
                        <b-progress class="mt-1" show-value :max="book.words.length">
                            <b-progress-bar show-value :value="book.getUnknownCount()" variant="danger"></b-progress-bar>
                            <b-progress-bar show-value :value="book.getLearnCount()" variant="warning"></b-progress-bar>
                            <b-progress-bar show-value :value="book.getKnownCount()" variant="success"></b-progress-bar>
                        </b-progress>
                    </b-form-group>
                    <b-form-group>
...
<script>
    import {Dictionary, Book} from './Words'
